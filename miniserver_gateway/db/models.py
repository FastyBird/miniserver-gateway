...
class ChannelPropertyTriggerEntity(TriggerEntity):
    _discriminator_: str = "channel_property"

    operator: ConditionOperators = Required(
        ConditionOperators,
        column="trigger_channel_property_operator",
        nullable=True
    )
    operand: str = Required(str, column="trigger_channel_property_operand", max_len=100, nullable=True)

    device: str = Required(str, column="trigger_channel_property_device", max_len=100, nullable=True)
    channel: str = Required(str, column="trigger_channel_property_channel", max_len=100, nullable=True)
    property: str = Required(str, column="trigger_channel_property_property", max_len=100, nullable=True)
