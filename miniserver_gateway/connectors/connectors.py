...
from miniserver_gateway.connectors.queue import CreateOrUpdateDeviceQueueItem,\
    CreateOrUpdateDeviceConfigurationQueueItem, DeleteDeviceConfigurationQueueItem,\
    CreateOrUpdateChannelPropertyQueueItem, DeleteChannelPropertyQueueItem, UpdatePropertyExpectedQueueItem,\
    CreateOrUpdateChannelConfigurationQueueItem, DeleteChannelConfigurationQueueItem
...
from miniserver_gateway.db.models import \
    ConnectorEntity,\
    DeviceEntity, DeviceConnectorEntity, DeviceConfigurationEntity,\
    ChannelEntity, ChannelPropertyEntity, ChannelConfigurationEntity
...
class Connectors(Thread):
            ...
            if not self.__queue.empty():
                ...
                if isinstance(record, CreateOrUpdateDeviceQueueItem):
                    self.__process_device_record(record)
                        ...
                        isinstance(record, CreateOrUpdateDeviceConfigurationQueueItem)
                        or isinstance(record, DeleteDeviceConfigurationQueueItem)
                ):
                    self.__process_device_configuration_record(record)

                elif (
                        isinstance(record, CreateOrUpdateChannelPropertyQueueItem)
                    ...
                    self.__process_property_expected_record(record)
                        ...
                        isinstance(record, CreateOrUpdateChannelConfigurationQueueItem)
    ...
    def add_or_edit_device(
        ...
        try:
            self.__queue.put(CreateOrUpdateDeviceQueueItem(
    ...
    def add_or_edit_device_configuration(
        ...
        try:
            self.__queue.put(CreateOrUpdateDeviceConfigurationQueueItem(
                device_id=device_id,
    ...
    def delete_device_configuration(
        ...
        try:
            self.__queue.put(DeleteDeviceConfigurationQueueItem(
                configuration_id=configuration_id
            ))
    ...
    def add_or_edit_channel_property(
        ...
        try:
            self.__queue.put(CreateOrUpdateChannelPropertyQueueItem(
                device_id=device_id,
    ...
    def delete_channel_property(
            self,
            property_id: uuid.UUID
    ) -> None:
        try:
            self.__queue.put(DeleteChannelPropertyQueueItem(
                property_id=property_id
            ))
    ...
    def add_or_edit_channel_configuration(
        ...
        try:
            self.__queue.put(CreateOrUpdateChannelConfigurationQueueItem(
                device_id=device_id,
                channel_id=channel_id,
                configuration_id=configuration_id,
                configuration_identifier=configuration_identifier,
    ...
    def delete_channel_configuration(
            self,
            configuration_id: uuid.UUID
    ) -> None:
        try:
            self.__queue.put(DeleteChannelConfigurationQueueItem(
                configuration_id=configuration_id
            ))
    ...
    def __publish_storage_value_event(
            self,
    ...
    def __publish_trigger_value_event(
            self,
            event: TriggerActionFiredEvent
    ) -> None:
        self.__publish_value_event(event.record, event.expected_value)
    ...
    def __publish_value_event(
        ...
        try:
            self.__queue.put(UpdatePropertyExpectedQueueItem(
                item=item,
                expected=value
            ))
    ...
    def __load(
        ...
        for connector in ConnectorEntity.select():
            ...
            try:
                ...
                connector_module: ConnectorInterface = connector_class(
                    self,
                    connector
                )
    ...
    @orm.db_session
    def __process_device_record(
            self,
            record: CreateOrUpdateDeviceQueueItem
    ) -> None:
        ...
        if isinstance(record, CreateOrUpdateDeviceConfigurationQueueItem):
            ...
            if device is not None:
                device_configuration: DeviceConfigurationEntity or None =\
                    DeviceConfigurationEntity.get(configuration_id=record.configuration_id)
            ...
            device_configuration: DeviceConfigurationEntity = DeviceConfigurationEntity.get(
    ...
    def __process_property_expected_record(
            self,
            record: UpdatePropertyExpectedQueueItem
    ) -> None:
        ...
        if isinstance(record, CreateOrUpdateChannelConfigurationQueueItem):
            ...
            if device is not None:
                ...
                channel_configuration: ChannelConfigurationEntity or None =\
                    ChannelConfigurationEntity.get(configuration_id=record.configuration_id)
    ...
    def __update_device_configuration_entity(
            self,
            channel_configuration: DeviceConfigurationEntity,
            **kwargs
    ) -> bool:
        available_attributes: List[str] = [
            "default",
